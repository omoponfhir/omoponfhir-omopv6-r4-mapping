...
//		}
	...
	public edu.gatech.chai.omopv6.model.entity.Observation constructOmopObservation(Long omopId,
			Observation fhirResource) {
		edu.gatech.chai.omopv6.model.entity.Observation observation = null;
		if (omopId == null) {
			// This is CREATE.
			observation = new edu.gatech.chai.omopv6.model.entity.Observation();
		} else {
...
//		SimpleDateFormat timeFormat = new SimpleDateFormat("HH:mm:ss");
		if (fhirResource.getEffective() instanceof DateTimeType) {
			...
			// Observation DateTime is required field in v6.0
			observation.setObservationDateTime(new Date(0)); 
		}
...
//							identifier_value = identifier.getValue();
//							if (identifier_value != null) {
//								List<edu.gatech.chai.omopv6.jpa.entity.Observation> results = observationService
...
//					omopSystem = OmopCodeableConceptMapping.omopVocabularyforFhirUri(fhirSystem);
		...
		if (entityMap != null && ((String) entityMap.get("type")).equalsIgnoreCase("measurement")) {
			...
			observation = (edu.gatech.chai.omopv6.model.entity.Observation) entityMap.get("entity");
