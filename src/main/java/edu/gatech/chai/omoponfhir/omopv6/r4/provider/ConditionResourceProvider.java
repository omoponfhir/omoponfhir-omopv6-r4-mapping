...
import edu.gatech.chai.omoponfhir.omopv6.r4.mapping.OmopCondition;
...
public class ConditionResourceProvider implements IResourceProvider {
	...
	public IBundleProvider findConditionByParams(
			...
			@OptionalParam(name = Condition.SP_RECORDED_DATE) DateRangeParam theDateRecorded) {
		List<ParameterWrapper> paramList = new ArrayList<ParameterWrapper>();
		...
		if (theDateRecorded != null) {
			paramList.addAll(myMapper.mapParameter(Condition.SP_RECORDED_DATE, theDateRecorded, false));
		}
