...
import edu.gatech.chai.omoponfhir.omopv6.r4.model.MyDocumentReference;
import edu.gatech.chai.omoponfhir.omopv6.r4.provider.DocumentReferenceResourceProvider;
...
//			TODO in the future, we want to deal with all of these encounters isntead of just the first
		...
		note.setNoteEventFieldConcept(new Concept(0L));
