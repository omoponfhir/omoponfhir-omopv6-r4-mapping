...
import edu.gatech.chai.omoponfhir.omopv6.r4.provider.MedicationRequestResourceProvider;
import edu.gatech.chai.omoponfhir.omopv6.r4.provider.MedicationResourceProvider;
import edu.gatech.chai.omoponfhir.omopv6.r4.provider.MedicationStatementResourceProvider;
...
import edu.gatech.chai.omopv6.dba.service.DrugExposureService;
import edu.gatech.chai.omopv6.dba.service.FPersonService;
import edu.gatech.chai.omopv6.dba.service.ParameterWrapper;
import edu.gatech.chai.omopv6.dba.service.ProviderService;
...
//			String resourceName = ((ReferenceParam) value).getResourceType();
		...
		case MedicationRequest.SP_AUTHOREDON:
			DateRangeParam authoredOnDateRange = ((DateRangeParam) value);
			DateUtil.constructParameterWrapper(authoredOnDateRange, "drugExposureStartDate", paramWrapper, mapList);
			break;
